...
using Service.WalletApi.EducationEconomicsApi.Controllers.Contracts;
using Service.WalletApi.EducationEconomicsApi.Mappers;
using Service.Web;

namespace Service.WalletApi.EducationEconomicsApi.Controllers
{
	[Route("/api/v1/education/economics")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialEconomicsService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialEconomicsService> tutorialService,
