...
using Service.WalletApi.EducationEconomicsApi.Modules;

namespace Service.WalletApi.EducationEconomicsApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/economics");
