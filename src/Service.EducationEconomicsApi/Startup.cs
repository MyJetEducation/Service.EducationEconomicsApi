...
using Service.EducationEconomicsApi.Modules;
using Service.Web;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.EducationEconomicsApi
{
	public class Startup
	{
		private const string DocumentName = "education/economics";
		private const string ApiName = "EducationEconomicsApi";
